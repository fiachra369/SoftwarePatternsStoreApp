...
public class MainAdminActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void loadCategories() {
        ...
        categoriesViewModel.getCategories().observe(this, new Observer<List<Categories>>() {
            ...
            public void onChanged(@Nullable List<Categories> categories) {
                mCategoriesAdapter = new CategoriesAdapter(MainAdminActivity.this, categories);
                ...
                if (mLayoutState != null) {
                    Objects.requireNonNull(mCategoriesRecyclerView.getLayoutManager()).onRestoreInstanceState(mLayoutState);
                }
            }
        });
    ...
    @OnClick(R.id.addCategoryFAB)
    public void onAddCategoryFABClick() {
        startActivity(new Intent(this, AddCategoryActivity.class));
        mFABsMenu.close(true);
    }

    @OnClick(R.id.checkOrdersFAB)
    public void onCheckOrdersFABClick() {
        startActivity(new Intent(this, OrderAdminActivity.class));
        mFABsMenu.close(true);
    }
    ...
    private void setupNavigationDrawer() {
        ...
        mToolbar.setTitle(R.string.admin_app_name);
    }
