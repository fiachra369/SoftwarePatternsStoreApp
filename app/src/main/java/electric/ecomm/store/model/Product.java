...
public class Product implements Serializable {
    ...
    public Product(String name, String description, String category, int code, int stock, float price, String image, float sale, Date timeStamp) {
        this.name = name;
    ...
    @Ignore
    public Product(String name, String description, String category, String imageUrl, int code, int stock, float price, float sale) {
        this.name = name;
        this.description = description;
        this.category = category;
        this.code = code;
